...
public class MenuFrame extends JFrame {
    ...
    public MenuFrame() {
        ...
        cutAction.putValue(Action.SMALL_ICON, new ImageIcon("D:\\JavaCoreV1Reading\\src\\Chapter11\\Section5\\menu\\cut.gif"));
        var copyAction = new TestAction("Copy");
        copyAction.putValue(Action.SMALL_ICON, new ImageIcon("D:\\JavaCoreV1Reading\\src\\Chapter11\\Section5\\menu\\copy.gif"));
        var pasteAction = new TestAction("Paste");
        pasteAction.putValue(Action.SMALL_ICON, new ImageIcon("D:\\JavaCoreV1Reading\\src\\Chapter11\\Section5\\menu\\paste.gif"));
